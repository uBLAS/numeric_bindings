...
inline void gbrfs( Trans, fortran_int_t n, fortran_int_t kl, fortran_int_t ku,
        fortran_int_t nrhs, const float* ab, fortran_int_t ldab,
        const float* afb, fortran_int_t ldafb, const fortran_int_t* ipiv,
...
inline void gbrfs( Trans, fortran_int_t n, fortran_int_t kl, fortran_int_t ku,
        ...
        const double* afb, fortran_int_t ldafb, const fortran_int_t* ipiv,
...
struct gbrfs_impl< Value, typename boost::enable_if< is_real< Value > >::type > {
    ...
    static void invoke( const fortran_int_t n, const MatrixAB& ab,
        ...
        detail::gbrfs( trans(), n, bandwidth_lower(ab), bandwidth_upper(ab),
                size_column(x), begin_value(ab), stride_major(ab),
                begin_value(afb), stride_major(afb), begin_value(ipiv),
    ...
    static void invoke( const fortran_int_t n, const MatrixAB& ab,
        ...
        bindings::detail::array< fortran_int_t > tmp_iwork(
                min_size_iwork( n ) );
        invoke( n, ab, afb, ipiv, b, x, ferr, berr, info, workspace( tmp_work,
                tmp_iwork ) );
    }
    ...
    static void invoke( const fortran_int_t n, const MatrixAB& ab,
        ...
        invoke( n, ab, afb, ipiv, b, x, ferr, berr, info,
                minimal_workspace() );
    }
...
inline std::ptrdiff_t gbrfs( const fortran_int_t n,
    ...
    gbrfs_impl< typename value< MatrixAB >::type >::invoke( n, ab, afb,
            ipiv, b, x, ferr, berr, info, work );
    return info;
}
...
inline std::ptrdiff_t gbrfs( const fortran_int_t n,
    ...
    fortran_int_t info(0);
    gbrfs_impl< typename value< MatrixAB >::type >::invoke( n, ab, afb,
            ipiv, b, x, ferr, berr, info, optimal_workspace() );
    return info;
}
