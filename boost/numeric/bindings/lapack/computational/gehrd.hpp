...
//
inline void gehrd( fortran_int_t n, fortran_int_t ilo, fortran_int_t ihi,
...
struct gehrd_impl< Value, typename boost::enable_if< is_real< Value > >::type > {
    ...
    static void invoke( const fortran_int_t ilo,
...
inline std::ptrdiff_t gehrd( const fortran_int_t ilo,
    ...
    gehrd_impl< typename value< MatrixA >::type >::invoke( ilo, ihi, a,
            tau, info, work );
    return info;
}
