...
//
inline void gelqf( fortran_int_t m, fortran_int_t n, float* a,
...
//
inline void gelqf( fortran_int_t m, fortran_int_t n, double* a,
...
//
inline void gelqf( fortran_int_t m, fortran_int_t n, std::complex<float>* a,
...
//
inline void gelqf( fortran_int_t m, fortran_int_t n, std::complex<double>* a,
...
inline std::ptrdiff_t gelqf( MatrixA& a, VectorTAU& tau,
    ...
    gelqf_impl< typename value< MatrixA >::type >::invoke( a, tau, info,
            work );
    return info;
}
