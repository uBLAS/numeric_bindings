...
//
inline void geqlf( fortran_int_t m, fortran_int_t n, float* a,
...
//
inline void geqlf( fortran_int_t m, fortran_int_t n, double* a,
...
//
inline void geqlf( fortran_int_t m, fortran_int_t n, std::complex<float>* a,
...
//
inline void geqlf( fortran_int_t m, fortran_int_t n, std::complex<double>* a,
...
inline std::ptrdiff_t geqlf( MatrixA& a, VectorTAU& tau,
        Workspace work ) {
    fortran_int_t info(0);
    geqlf_impl< typename value< MatrixA >::type >::invoke( a, tau, info,
            work );
    return info;
}
...
//
template< typename MatrixA, typename VectorTAU, typename Workspace >
inline std::ptrdiff_t geqlf( const MatrixA& a, VectorTAU& tau,
        Workspace work ) {
    fortran_int_t info(0);
    geqlf_impl< typename value< MatrixA >::type >::invoke( a, tau, info,
            work );
...
//
template< typename MatrixA, typename VectorTAU, typename Workspace >
inline std::ptrdiff_t geqlf( MatrixA& a, const VectorTAU& tau,
        Workspace work ) {
    fortran_int_t info(0);
    geqlf_impl< typename value< MatrixA >::type >::invoke( a, tau, info,
            work );
...
//
template< typename MatrixA, typename VectorTAU, typename Workspace >
inline std::ptrdiff_t geqlf( const MatrixA& a, const VectorTAU& tau,
        Workspace work ) {
    fortran_int_t info(0);
    geqlf_impl< typename value< MatrixA >::type >::invoke( a, tau, info,
            work );
