...
inline void ormlq( char side, Trans, fortran_int_t m, fortran_int_t n,
...
template< typename MatrixA, typename VectorTAU, typename MatrixC,
        typename Workspace >
inline std::ptrdiff_t ormlq( const char side, const fortran_int_t k,
        const MatrixA& a, const VectorTAU& tau, MatrixC& c, Workspace work ) {
    fortran_int_t info(0);
    ormlq_impl< typename value< MatrixA >::type >::invoke( side, k, a,
            tau, c, info, work );
    return info;
}
