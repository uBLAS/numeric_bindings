...
inline void pbrfs( UpLo, fortran_int_t n, fortran_int_t kd,
...
struct pbrfs_impl< Value, typename boost::enable_if< is_real< Value > >::type > {
    ...
    static void invoke( const fortran_int_t n, const MatrixAB& ab,
            const MatrixAFB& afb, const MatrixB& b, MatrixX& x,
        ...
        detail::pbrfs( uplo(), n, bandwidth_upper(ab), size_column(x),
    ...
    static void invoke( const fortran_int_t n, const MatrixAB& ab,
        ...
        bindings::detail::array< fortran_int_t > tmp_iwork(
                min_size_iwork( n ) );
        invoke( n, ab, afb, b, x, ferr, berr, info, workspace( tmp_work,
                tmp_iwork ) );
    }
    ...
    static void invoke( const fortran_int_t n, const MatrixAB& ab,
        ...
        invoke( n, ab, afb, b, x, ferr, berr, info, minimal_workspace() );
    }
...
inline std::ptrdiff_t pbrfs( const fortran_int_t n,
    ...
    pbrfs_impl< typename value< MatrixAB >::type >::invoke( n, ab, afb,
