...
inline void pbstf( UpLo, fortran_int_t n, fortran_int_t kd, float* ab,
...
//
template< typename UpLo >
inline void pbstf( UpLo, fortran_int_t n, fortran_int_t kd, double* ab,
        fortran_int_t ldab, fortran_int_t& info ) {
...
//
template< typename UpLo >
inline void pbstf( UpLo, fortran_int_t n, fortran_int_t kd,
...
struct pbstf_impl {
    ...
    static void invoke( const fortran_int_t n, MatrixAB& ab,
        ...
        detail::pbstf( uplo(), n, bandwidth_upper(ab), begin_value(ab),
...
inline std::ptrdiff_t pbstf( const fortran_int_t n, MatrixAB& ab ) {
    ...
    pbstf_impl< typename value< MatrixAB >::type >::invoke( n, ab, info );
    return info;
}
