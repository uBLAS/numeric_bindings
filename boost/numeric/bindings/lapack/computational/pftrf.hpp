...
inline void pftrf( TransR, UpLo, fortran_int_t n, float* a,
        fortran_int_t& info ) {
...
//
template< typename TransR, typename UpLo >
inline void pftrf( TransR, UpLo, fortran_int_t n, double* a,
        fortran_int_t& info ) {
...
//
template< typename TransR, typename UpLo >
inline void pftrf( TransR, UpLo, fortran_int_t n, std::complex<float>* a,
        fortran_int_t& info ) {
...
//
template< typename TransR, typename UpLo >
inline void pftrf( TransR, UpLo, fortran_int_t n, std::complex<double>* a,
        fortran_int_t& info ) {
...
struct pftrf_impl {
    ...
    static void invoke( MatrixA& a, fortran_int_t& info ) {
        ...
        detail::pftrf( transr(), uplo(), size_column_op(a, transr()),
                begin_value(a), info );
    }
...
inline std::ptrdiff_t pftrf( MatrixA& a ) {
    ...
    pftrf_impl< typename value< MatrixA >::type >::invoke( a, info );
    return info;
}
