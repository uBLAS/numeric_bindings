...
inline void potrs( UpLo, fortran_int_t n, fortran_int_t nrhs, const float* a,
        fortran_int_t lda, float* b, fortran_int_t ldb, fortran_int_t& info ) {
...
//
template< typename UpLo >
inline void potrs( UpLo, fortran_int_t n, fortran_int_t nrhs, const double* a,
        fortran_int_t lda, double* b, fortran_int_t ldb,
        fortran_int_t& info ) {
...
//
template< typename UpLo >
inline void potrs( UpLo, fortran_int_t n, fortran_int_t nrhs,
...
struct potrs_impl {
    ...
    static void invoke( const MatrixA& a, MatrixB& b,
            fortran_int_t& info ) {
        ...
        BOOST_ASSERT( stride_major(b) >= std::max< std::ptrdiff_t >(1,
                size_column(a)) );
        detail::potrs( uplo(), size_column(a), size_column(b), begin_value(a),
                stride_major(a), begin_value(b), stride_major(b), info );
    }
...
inline std::ptrdiff_t potrs( const MatrixA& a, MatrixB& b ) {
    ...
    potrs_impl< typename value< MatrixA >::type >::invoke( a, b, info );
    return info;
}
