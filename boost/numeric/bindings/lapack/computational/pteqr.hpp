...
//
inline void pteqr( char compz, fortran_int_t n, float* d, float* e, float* z,
...
//
inline void pteqr( char compz, fortran_int_t n, double* d, double* e,
...
//
inline void pteqr( char compz, fortran_int_t n, float* d, float* e,
...
struct pteqr_impl< Value, typename boost::enable_if< is_real< Value > >::type > {
    ...
    static void invoke( const char compz, const fortran_int_t n,
        ...
        detail::pteqr( compz, n, begin_value(d), begin_value(e),
...
inline std::ptrdiff_t pteqr( const char compz, const fortran_int_t n,
    ...
    pteqr_impl< typename value< MatrixZ >::type >::invoke( compz, n, d,
            e, z, info, work );
    return info;
}
