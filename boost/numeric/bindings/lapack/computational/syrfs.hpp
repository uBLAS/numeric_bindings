...
inline void syrfs( UpLo, fortran_int_t n, fortran_int_t nrhs, const float* a,
...
//
template< typename UpLo >
inline void syrfs( UpLo, fortran_int_t n, fortran_int_t nrhs, const double* a,
...
//
template< typename UpLo >
inline void syrfs( UpLo, fortran_int_t n, fortran_int_t nrhs,
...
struct syrfs_impl< Value, typename boost::enable_if< is_real< Value > >::type > {
    ...
    static void invoke( const MatrixA& a, const MatrixAF& af,
        ...
        BOOST_ASSERT( stride_major(x) >= std::max< std::ptrdiff_t >(1,
                size_column(a)) );
        detail::syrfs( uplo(), size_column(a), size_column(x), begin_value(a),
...
//
template< typename Value >
struct syrfs_impl< Value, typename boost::enable_if< is_complex< Value > >::type > {
...
inline std::ptrdiff_t syrfs( const MatrixA& a, const MatrixAF& af,
    ...
    syrfs_impl< typename value< MatrixA >::type >::invoke( a, af, ipiv,
