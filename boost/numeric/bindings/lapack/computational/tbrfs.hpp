...
inline void tbrfs( char uplo, Trans, Diag, fortran_int_t n, fortran_int_t kd,
        fortran_int_t nrhs, const float* ab, fortran_int_t ldab,
        const float* b, fortran_int_t ldb, const float* x, fortran_int_t ldx,
...
struct tbrfs_impl< Value, typename boost::enable_if< is_real< Value > >::type > {
    ...
    static void invoke( const char uplo, const fortran_int_t n,
        ...
        detail::tbrfs( uplo, trans(), diag(), n, kd, size_column(x),
    ...
    static void invoke( const char uplo, const fortran_int_t n,
        ...
        bindings::detail::array< fortran_int_t > tmp_iwork(
                min_size_iwork( n ) );
        invoke( uplo, n, kd, ab, b, x, ferr, berr, info, workspace( tmp_work,
                tmp_iwork ) );
    }
    ...
    static void invoke( const char uplo, const fortran_int_t n,
        ...
        typedef typename result_of::diag_tag< MatrixAB >::type diag;
        invoke( uplo, n, kd, ab, b, x, ferr, berr, info, minimal_workspace() );
    }
...
inline std::ptrdiff_t tbrfs( const char uplo, const fortran_int_t n,
    ...
    tbrfs_impl< typename value< MatrixAB >::type >::invoke( uplo, n, kd,
            ab, b, x, ferr, berr, info, work );
    return info;
}
...
inline std::ptrdiff_t tbrfs( const char uplo, const fortran_int_t n,
    ...
    fortran_int_t info(0);
    tbrfs_impl< typename value< MatrixAB >::type >::invoke( uplo, n, kd,
            ab, b, x, ferr, berr, info, optimal_workspace() );
    return info;
}
