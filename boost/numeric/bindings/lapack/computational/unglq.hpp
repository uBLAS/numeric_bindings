...
//
inline void unglq( fortran_int_t m, fortran_int_t n, fortran_int_t k,
...
inline std::ptrdiff_t unglq( const fortran_int_t m,
        const fortran_int_t n, const fortran_int_t k, MatrixA& a,
        const VectorTAU& tau, Workspace work ) {
    fortran_int_t info(0);
    unglq_impl< typename value< MatrixA >::type >::invoke( m, n, k, a,
            tau, info, work );
    return info;
}
