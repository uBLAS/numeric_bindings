...
inline void unmbr( char vect, char side, Trans, fortran_int_t m,
...
struct unmbr_impl {
    ...
    static void invoke( const char vect, const char side,
        ...
        detail::unmbr( vect, side, trans(), size_row(c), size_column(c), k,
...
inline std::ptrdiff_t unmbr( const char vect, const char side,
    ...
    unmbr_impl< typename value< MatrixA >::type >::invoke( vect, side, k,
            a, tau, c, info, work );
    return info;
}
