...
inline void unmlq( char side, Trans, fortran_int_t m, fortran_int_t n,
        fortran_int_t k, const std::complex<float>* a, fortran_int_t lda,
...
template< typename Trans >
inline void unmlq( char side, Trans, fortran_int_t m, fortran_int_t n,
        fortran_int_t k, const std::complex<double>* a, fortran_int_t lda,
...
template< typename MatrixA, typename VectorTAU, typename MatrixC,
        typename Workspace >
inline std::ptrdiff_t unmlq( const char side, const fortran_int_t k,
        const MatrixA& a, const VectorTAU& tau, MatrixC& c, Workspace work ) {
    fortran_int_t info(0);
    unmlq_impl< typename value< MatrixA >::type >::invoke( side, k, a,
            tau, c, info, work );
    return info;
}
