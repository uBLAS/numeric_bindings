...
//
inline void ggev( char jobvl, char jobvr, fortran_int_t n, float* a,
...
//
inline void ggev( char jobvl, char jobvr, fortran_int_t n, double* a,
...
//
inline void ggev( char jobvl, char jobvr, fortran_int_t n,
...
inline std::ptrdiff_t ggev( const char jobvl, const char jobvr,
    ...
    ggev_impl< typename value< MatrixA >::type >::invoke( jobvl, jobvr,
