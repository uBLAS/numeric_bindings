...
//
inline void ggsvd( char jobu, char jobv, char jobq, fortran_int_t m,
...
struct ggsvd_impl< Value, typename boost::enable_if< is_real< Value > >::type > {
    ...
    static void invoke( const char jobu, const char jobv, const char jobq,
            ...
            MatrixV& v, MatrixQ& q, fortran_int_t& info,
        ...
        BOOST_ASSERT( stride_major(b) >= std::max< std::ptrdiff_t >(1,
                size_row(b)) );
        detail::ggsvd( jobu, jobv, jobq, size_row(a), size_column(b),
...
inline std::ptrdiff_t ggsvd( const char jobu, const char jobv,
    ...
    ggsvd_impl< typename value< MatrixA >::type >::invoke( jobu, jobv,
            jobq, k, l, a, b, alpha, beta, u, v, q, info, work );
    return info;
}
...
inline std::ptrdiff_t ggsvd( const char jobu, const char jobv,
    ...
    fortran_int_t info(0);
    ggsvd_impl< typename value< MatrixA >::type >::invoke( jobu, jobv,
            jobq, k, l, a, b, alpha, beta, u, v, q, info,
            optimal_workspace() );
    return info;
}
...
template< typename MatrixA, typename MatrixB, typename VectorALPHA,
        ...
        typename MatrixQ, typename Workspace >
inline std::ptrdiff_t ggsvd( const char jobu, const char jobv,
        const char jobq, const fortran_int_t& k, fortran_int_t& l,
        MatrixA& a, MatrixB& b, VectorALPHA& alpha, VectorBETA& beta,
        MatrixU& u, MatrixV& v, MatrixQ& q, Workspace work ) {
    fortran_int_t info(0);
    ggsvd_impl< typename value< MatrixA >::type >::invoke( jobu, jobv,
...
template< typename MatrixA, typename MatrixB, typename VectorALPHA,
        ...
        typename MatrixQ, typename Workspace >
inline std::ptrdiff_t ggsvd( const char jobu, const char jobv,
        const char jobq, fortran_int_t& k, const fortran_int_t& l,
        MatrixA& a, MatrixB& b, VectorALPHA& alpha, VectorBETA& beta,
        MatrixU& u, MatrixV& v, MatrixQ& q, Workspace work ) {
    fortran_int_t info(0);
    ggsvd_impl< typename value< MatrixA >::type >::invoke( jobu, jobv,
...
inline std::ptrdiff_t ggsvd( const char jobu, const char jobv,
        const char jobq, const fortran_int_t& k,
        const fortran_int_t& l, const MatrixA& a, MatrixB& b,
        VectorALPHA& alpha, VectorBETA& beta, MatrixU& u, MatrixV& v,
        MatrixQ& q, Workspace work ) {
    fortran_int_t info(0);
    ggsvd_impl< typename value< MatrixA >::type >::invoke( jobu, jobv,
...
inline std::ptrdiff_t ggsvd( const char jobu, const char jobv,
        const char jobq, const fortran_int_t& k,
        const fortran_int_t& l, MatrixA& a, const MatrixB& b,
        VectorALPHA& alpha, VectorBETA& beta, MatrixU& u, MatrixV& v,
        MatrixQ& q, Workspace work ) {
    fortran_int_t info(0);
    ggsvd_impl< typename value< MatrixA >::type >::invoke( jobu, jobv,
...
inline std::ptrdiff_t ggsvd( const char jobu, const char jobv,
        const char jobq, const fortran_int_t& k,
        const fortran_int_t& l, const MatrixA& a, const MatrixB& b,
        VectorALPHA& alpha, VectorBETA& beta, MatrixU& u, MatrixV& v,
        MatrixQ& q, Workspace work ) {
    fortran_int_t info(0);
    ggsvd_impl< typename value< MatrixA >::type >::invoke( jobu, jobv,
