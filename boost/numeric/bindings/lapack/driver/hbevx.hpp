...
inline void hbevx( char jobz, char range, UpLo, fortran_int_t n,
...
struct hbevx_impl {
    ...
    static void invoke( const char jobz, const char range,
        ...
        detail::hbevx( jobz, range, uplo(), n, bandwidth_upper(ab),
    ...
    static void invoke( const char jobz, const char range,
        ...
        bindings::detail::array< fortran_int_t > tmp_iwork(
                min_size_iwork( n ) );
        invoke( jobz, range, n, ab, q, vl, vu, il, iu, abstol, m, w, z, ifail,
...
inline std::ptrdiff_t hbevx( const char jobz, const char range,
    ...
    hbevx_impl< typename value< MatrixAB >::type >::invoke( jobz, range,
            n, ab, q, vl, vu, il, iu, abstol, m, w, z, ifail, info, work );
    return info;
}
...
inline std::ptrdiff_t hbevx( const char jobz, const char range,
    ...
    fortran_int_t info(0);
    hbevx_impl< typename value< MatrixAB >::type >::invoke( jobz, range,
            n, ab, q, vl, vu, il, iu, abstol, m, w, z, ifail, info,
            optimal_workspace() );
    return info;
}
