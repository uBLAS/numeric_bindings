...
inline void hbgvd( char jobz, UpLo, fortran_int_t n, fortran_int_t ka,
...
struct hbgvd_impl {
    ...
    static void invoke( const char jobz, const fortran_int_t n,
        ...
        bindings::detail::array< fortran_int_t > tmp_iwork(
                min_size_iwork( jobz, n ) );
        invoke( jobz, n, ab, bb, w, z, info, workspace( tmp_work, tmp_rwork,
                tmp_iwork ) );
    }
...
inline std::ptrdiff_t hbgvd( const char jobz, const fortran_int_t n,
    ...
    hbgvd_impl< typename value< MatrixAB >::type >::invoke( jobz, n, ab,
            bb, w, z, info, work );
    return info;
}
