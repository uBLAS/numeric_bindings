...
heevd( const char jobz, MatrixA& a, VectorW& w, Workspace work ) {
    return heevd_impl< typename value< MatrixA >::type >::invoke( jobz,
            a, w, work );
}
...
inline typename boost::enable_if< detail::is_workspace< Workspace >,
        std::ptrdiff_t >::type
heevd( const char jobz, MatrixA& a, const VectorW& w, Workspace work ) {
    return heevd_impl< typename value< MatrixA >::type >::invoke( jobz,
            a, w, work );
}
...
inline typename boost::disable_if< detail::is_workspace< VectorW >,
        std::ptrdiff_t >::type
heevd( const char jobz, MatrixA& a, const VectorW& w ) {
    return heevd_impl< typename value< MatrixA >::type >::invoke( jobz,
            a, w, optimal_workspace() );
}
...
inline typename boost::enable_if< detail::is_workspace< Workspace >,
        std::ptrdiff_t >::type
heevd( const char jobz, const MatrixA& a, const VectorW& w,
        Workspace work ) {
    return heevd_impl< typename value< MatrixA >::type >::invoke( jobz,
            a, w, work );
}
