...
inline void hpsv( UpLo, fortran_int_t n, fortran_int_t nrhs,
...
struct hpsv_impl {
    ...
    static void invoke( MatrixAP& ap, VectorIPIV& ipiv, MatrixB& b,
        ...
        BOOST_ASSERT( stride_major(b) >= std::max< std::ptrdiff_t >(1,
                size_column(ap)) );
        detail::hpsv( uplo(), size_column(ap), size_column(b),
...
inline std::ptrdiff_t hpsv( MatrixAP& ap, VectorIPIV& ipiv,
    ...
    hpsv_impl< typename value< MatrixAP >::type >::invoke( ap, ipiv, b,
            info );
    return info;
}
