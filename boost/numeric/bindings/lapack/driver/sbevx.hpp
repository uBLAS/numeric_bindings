...
inline void sbevx( char jobz, char range, UpLo, fortran_int_t n,
...
struct sbevx_impl {
    ...
    static void invoke( const char jobz, const char range,
        ...
        detail::sbevx( jobz, range, uplo(), n, bandwidth_upper(ab),
...
inline std::ptrdiff_t sbevx( const char jobz, const char range,
    ...
    sbevx_impl< typename value< MatrixAB >::type >::invoke( jobz, range,
