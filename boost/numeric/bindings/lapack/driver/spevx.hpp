...
inline void spevx( char jobz, char range, UpLo, fortran_int_t n, float* ap,
...
//
template< typename UpLo >
inline void spevx( char jobz, char range, UpLo, fortran_int_t n, double* ap,
...
struct spevx_impl {
    ...
    static void invoke( const char jobz, const char range,
        ...
        detail::spevx( jobz, range, uplo(), n, begin_value(ap), vl, vu, il,
...
inline std::ptrdiff_t spevx( const char jobz, const char range,
    ...
    spevx_impl< typename value< MatrixAP >::type >::invoke( jobz, range,
            n, ap, vl, vu, il, iu, abstol, m, w, z, ifail, info, work );
    return info;
}
...
inline std::ptrdiff_t spevx( const char jobz, const char range,
    ...
    fortran_int_t info(0);
    spevx_impl< typename value< MatrixAP >::type >::invoke( jobz, range,
            n, ap, vl, vu, il, iu, abstol, m, w, z, ifail, info,
            optimal_workspace() );
    return info;
}
...
inline std::ptrdiff_t spevx( const char jobz, const char range,
        ...
        const fortran_int_t il, const fortran_int_t iu,
        const typename remove_imaginary< typename value<
        MatrixAP >::type >::type abstol, const fortran_int_t& m,
