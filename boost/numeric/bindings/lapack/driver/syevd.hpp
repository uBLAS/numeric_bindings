...
inline void syevd( char jobz, UpLo, fortran_int_t n, float* a,
...
//
template< typename UpLo >
inline void syevd( char jobz, UpLo, fortran_int_t n, double* a,
...
inline std::ptrdiff_t syevd( const char jobz, MatrixA& a, VectorW& w,
    ...
    syevd_impl< typename value< MatrixA >::type >::invoke( jobz, a, w,
            info, work );
    return info;
}
